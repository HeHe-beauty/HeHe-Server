...
public class ScheduleController implements ScheduleApiSpecification {
    ...
    @Override
    @GetMapping("/summary")
    public ApiResult<Map<String, Integer>> getScheduleSummary(@LoginUser Long userId) {
    ...
    @Override
    @GetMapping("/daily")
    public ApiResult<List<ScheduleResponse>> getSchedulesByDate(@LoginUser Long userId,
    ...
    @Override
    @GetMapping("/upcoming")
    public ApiResult<List<ScheduleResponse>> getUpcomingSchedules(@LoginUser Long userId,
    ...
    public ApiResult<ScheduleCreateResponse> createSchedule(@LoginUser Long userId,
    ...
    public ApiResult<ScheduleResponse> updateSchedule(@LoginUser Long userId,
                                                         @PathVariable Long scheduleId,
